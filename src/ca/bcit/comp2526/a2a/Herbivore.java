...
public class Herbivore extends LivingThing implements ILivingThing {
     ...
     * (non-Javadoc)
     * @see
     * ca.bcit.comp2526.a2a.ILivingThing#preyOn(ca.bcit.comp2526.a2a.IThing)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see ca.bcit.comp2526.a2a.LivingThing#reproduce(ca.bcit.comp2526.a2a.
     * ILivingThing)
     */
    @Override
    ...
    public Cell move() {
        ...
        for (int i = 0; i < adjacent.size(); i++) {
            index = RandomGenerator.nextNumber(adjacent.size() - 1);
